  ...
  return ( 
    <div className = {styles.bgcolor}>
        ...
        <div className = {styles.marginStyle}>
          ...
          <h3 className = {styles.text}>{'\t'}The food expiration display system, Pantry's most important feature, will allow a user to show any foods set to expire in the near future at the top of the list. This prominent reminder will make sure that all food can be used with minimal waste. Pantry will help you to make better use of food within a timely manner, and reduce the amount of waste due to food expiring unexpectedly.</h3>          </div>        </div>
      </div>
   );
}
